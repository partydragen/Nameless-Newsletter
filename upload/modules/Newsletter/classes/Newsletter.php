...
class Newsletter {
    ...
    public static function updateCheck() {
        ...
        curl_setopt($ch, CURLOPT_URL, 'https://api.partydragen.com/stats.php?uid=' . $uid . '&version=' . $current_version . '&module=Newsletter&module_version='.$module->getVersion() . '&domain='. Util::getSelfURL());
