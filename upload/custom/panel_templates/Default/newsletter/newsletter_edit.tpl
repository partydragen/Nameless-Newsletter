                    ...
                    <div class="card-body">
                        ...
                        <form role="form" action="" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" class="form-control" id="inputTitle" placeholder="{$TITLE}" value="{$NEWSLETTER_TITLE_VALUE}">
                            </div>

                            <div class="form-group">
                                <label for="inputContent">{$NEWSLETTER_CONTENT}</label>
                                <textarea id="inputContent" name="content" class="form-control">{$NEWSLETTER_CONTENT_VALUE}</textarea>
                            </div>
